/*
	MEMO:	Custom ThirdParty/AzureKinectExamples/Resources/UserBodyImageShader.shader
			指定したBodyIndexのBodyのみを描画
*/

// Upgrade NOTE: replaced 'mul(UNITY_MATRIX_MVP,*)' with 'UnityObjectToClipPos(*)'

Shader "HRYooba/Kinect/UserBodyImageByBodyIndexShader" {
//    Properties {
	...
	SubShader {
		Pass {
			...
			float4 frag (v2f i) : COLOR
			{
				...
				float clrPlayer = bi == _BodyIndex ? 1.0 : 0.0;
